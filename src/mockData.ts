import avatarStubUrl from '@/assets/images/avatar-stub.svg';
import profileAvatar from '@/assets/images/profile-avatar-stub.svg';
...
export const chatsList: Chat[] = [
  ...
  },
  {
    ...
    avatarUrl: avatarStubUrl,
    title: 'тет-а-теты',
    message: 'И Human Interface Guidelines и Material Design рекомендуют Interface Guidelines и Material',
    time: 'Ср',
    badge: 0,
  },
];
